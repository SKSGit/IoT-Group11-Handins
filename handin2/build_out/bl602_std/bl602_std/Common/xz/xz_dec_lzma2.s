...
lzma_len:
.LFB30:
	.file 1 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Common/xz/xz_dec_lzma2.c"
	.loc 1 621 1
	.cfi_startproc
.LVL0:
	.loc 1 622 5
...
.LBB389:
.LBB390:
	.loc 1 465 5 is_stmt 1 discriminator 1
...
.LBE408:
	...
	.loc 1 575 45 is_stmt 0
	lw	a1,104(s0)
.LVL66:
	.loc 1 576 5 is_stmt 1
	.loc 1 577 5
	.loc 1 576 34 is_stmt 0
	lw	a4,108(s0)
	.loc 1 575 36
	li	a2,8
.LVL67:
...
.LBE405:
.LBE404:
	.file 2 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Common/xz/xz_lzma2.h"
	.loc 2 95 5
.LBB461:
.LBB460:
...
.L112:
	.loc 1 936 11
	bltu	a5,a3,.L170
	.loc 1 936 35 discriminator 1
	li	a5,7
	bne	a4,a5,.L161
.L115:
	.loc 1 1060 9 is_stmt 1
	.loc 1 1072 13
	.loc 1 1072 48 is_stmt 0
	lw	a5,20(s1)
	lw	a3,16(s1)
	.loc 1 1072 13
	lw	a4,68(s0)
...
.L150:
	...
	.loc 1 875 22 is_stmt 0
	sw	zero,16(s0)
	.loc 1 877 9 is_stmt 1
	.loc 1 877 14 is_stmt 0
	mv	a0,s0
	call	lzma_main
.LVL232:
	.loc 1 877 12
...
.LBE511:
	...
	.loc 1 1080 16 is_stmt 0
	bne	s2,zero,.L160
	.loc 1 1081 17 is_stmt 1
	.loc 1 1081 20 is_stmt 0
	lw	a5,72(s0)
	bne	a5,zero,.L131
	.loc 1 1081 45 discriminator 1
	lw	a5,100(s0)
	bne	a5,zero,.L131
.LVL238:
	.loc 1 474 5 is_stmt 1
	.loc 1 1082 25 is_stmt 0
	lw	a5,4(s0)
	bne	a5,zero,.L131
	.loc 1 1085 17 is_stmt 1
.LVL239:
.LBB513:
.LBB514:
	.loc 1 440 5
...
.LVL241:
	...
	li	a4,223
	bgtu	a5,a4,.L124
	.loc 1 975 29 discriminator 1
	li	a4,1
	bne	a5,a4,.L125
.L124:
	.loc 1 976 17 is_stmt 1
	.loc 1 977 17
	.loc 1 977 42 is_stmt 0
	li	a4,256
	sh	a4,76(s0)
	.loc 1 978 17 is_stmt 1
.LVL242:
.LBB515:
.LBB516:
	.loc 1 288 5
...
.LBE515:
	...
	li	a4,127
	bleu	a5,a4,.L128
	.loc 1 984 17 is_stmt 1
	.loc 1 984 54 is_stmt 0
	slli	a4,a5,16
	li	a3,2031616
	and	a4,a4,a3
	.loc 1 984 39
	sw	a4,68(s0)
	.loc 1 985 17 is_stmt 1
	.loc 1 985 35 is_stmt 0
	li	a4,1
	sb	a4,64(s0)
	.loc 1 987 17 is_stmt 1
	.loc 1 987 20 is_stmt 0
	li	a4,191
	bleu	a5,a4,.L129
	.loc 1 993 21 is_stmt 1
	.loc 1 995 29 is_stmt 0
	li	a5,5
.LVL244:
	.loc 1 993 41
	sb	zero,77(s0)
	.loc 1 994 21 is_stmt 1
	.loc 1 995 29 is_stmt 0
	sb	a5,65(s0)
	j	.L111
.LVL245:
.L125:
	.loc 1 979 20 is_stmt 1
...
.L129:
	.cfi_restore_state
	.loc 1 997 24 is_stmt 1
	.loc 1 997 27 is_stmt 0
	lbu	a4,77(s0)
	bne	a4,zero,.L131
	.loc 1 1001 21 is_stmt 1
	.loc 1 1002 29 is_stmt 0
	li	a4,6
	sb	a4,65(s0)
	.loc 1 1003 21 is_stmt 1
...
.LBE518:
.LBE517:
	.loc 1 1007 17 is_stmt 1
	.loc 1 1007 20 is_stmt 0
	li	a4,2
	bgtu	a5,a4,.L131
	.loc 1 1010 17 is_stmt 1
	.loc 1 1011 17
	.loc 1 1010 35 is_stmt 0
	li	a5,4096
.LVL258:
	addi	a5,a5,-2045
	sh	a5,64(s0)
...
.L120:
	...
	.loc 1 1025 31 is_stmt 0
	li	a5,3
	j	.L195
.L119:
	.loc 1 1029 13 is_stmt 1
	.loc 1 1030 34 is_stmt 0
	lw	a4,0(s1)
	.loc 1 1030 48
	addi	a3,a5,1
	sw	a3,4(s1)
...
.LBE534:
	...
	.loc 1 1056 33 is_stmt 0
	lw	a5,72(s0)
	addi	a5,a5,-5
	sw	a5,72(s0)
	.loc 1 1057 13 is_stmt 1
	.loc 1 1057 31 is_stmt 0
	li	a5,7
	sb	a5,64(s0)
	j	.L115
.LVL268:
...
.LVL279:
	...
	.loc 1 899 40 is_stmt 0
	add	a5,a5,a3
	.loc 1 898 12
	bgeu	a4,a2,.L156
	.loc 1 901 13 is_stmt 1
	.loc 1 901 41 is_stmt 0
	lw	a5,8(s1)
	addi	a5,a5,-21
.L156:
	sw	a5,20(s0)
...
.LVL280:
	...
	.loc 1 906 25 is_stmt 0
	lw	a4,16(s0)
	.loc 1 906 36
	lw	a5,4(s1)
.LVL281:
	.loc 1 907 9 is_stmt 1
	.loc 1 907 32 is_stmt 0
	lw	a3,72(s0)
	.loc 1 906 18
	sub	a2,a4,a5
.LVL282:
...
.LBE505:
.LBE541:
	.loc 1 1088 20 is_stmt 1
	.loc 1 1088 23 is_stmt 0
	lw	a4,16(s1)
	lw	a5,20(s1)
	beq	a4,a5,.L161
	.loc 1 1089 21
...
.L198:
	.cfi_restore_state
	.loc 1 1128 12 is_stmt 1
	.loc 1 1128 15 is_stmt 0
	li	a5,2
	bne	s1,a5,.L196
...
.LVL310:
	...
	li	a4,2
	bne	a5,a4,.L205
	.loc 1 1152 13 is_stmt 1
	.loc 1 1152 16 is_stmt 0
	lw	a5,56(s0)
	bleu	a1,a5,.L205
	.loc 1 1153 17 is_stmt 1
	lw	a0,24(s0)
	call	simple_free
.LVL311:
	.loc 1 1154 17
	.loc 1 1154 31 is_stmt 0
	lw	a0,48(s0)
	call	simple_malloc
.LVL312:
	.loc 1 1154 29
	sw	a0,24(s0)
	.loc 1 1155 17 is_stmt 1
	.loc 1 1155 20 is_stmt 0
	bne	a0,zero,.L205
	.loc 1 1156 21 is_stmt 1
	.loc 1 1156 39 is_stmt 0
	sw	zero,56(s0)
	.loc 1 1157 21 is_stmt 1
	.loc 1 1157 28 is_stmt 0
	li	a0,3
.LVL313:
.L204:
	.loc 1 1171 1
...
.Letext0:
	...
	.file 10 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Common/xz/xz_config.h"
...
.LASF204:
	.string	"sequence"
.LASF275:
	.string	"/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Common/xz/xz_dec_lzma2.c"
.LASF63:
	.string	"_mbstate"
.LASF241:
	.string	"rc_bit"
