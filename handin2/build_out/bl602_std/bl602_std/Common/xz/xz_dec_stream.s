...
get_unaligned_le32:
.LFB1:
	.file 1 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Common/xz/xz_config.h"
	.loc 1 73 1
	.cfi_startproc
.LVL0:
	.loc 1 74 5
...
dec_vli:
.LFB6:
	.file 2 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Common/xz/xz_dec_stream.c"
...
.L5:
	...
	.loc 2 206 20 is_stmt 0
	li	a0,1
	j	.L6
.L4:
	.loc 2 209 9 is_stmt 1
	.loc 2 209 16 is_stmt 0
	addi	s1,s1,7
	sw	s1,4(s0)
	.loc 2 210 9 is_stmt 1
	.loc 2 210 12 is_stmt 0
	beq	s1,s5,.L7
.LVL12:
.L8:
	.loc 2 194 12
...
.LVL27:
	...
	.loc 2 858 12 is_stmt 0
	sw	zero,4(a0)
	.loc 2 859 5 is_stmt 1
	.loc 2 859 12 is_stmt 0
	sw	zero,24(a0)
	.loc 2 860 5 is_stmt 1
	li	a2,48
	li	a1,0
	addi	a0,a0,56
.LVL28:
...
.L24:
	.loc 2 797 5
	.loc 2 797 14 is_stmt 0
	lw	s2,4(s9)
.LVL34:
	.loc 2 798 5 is_stmt 1
.LBB18:
.LBB19:
	.loc 2 583 9 is_stmt 0
	lui	s3,%hi(.L28)
.LBE19:
.LBE18:
	.loc 2 798 15
...
.LVL40:
	...
	bne	a0,zero,.L38
.L108:
	.loc 2 719 21 is_stmt 1
	.loc 2 719 28 is_stmt 0
	li	s8,0
	j	.L39
.L38:
	.loc 2 603 13 is_stmt 1
	.loc 2 603 25 is_stmt 0
	li	s8,1
	sb	s8,0(s0)
...
.LBE58:
	...
	.loc 2 801 8 is_stmt 0
	lbu	a4,29(s0)
	bne	a4,zero,.L77
	.loc 2 802 9 is_stmt 1
	.loc 2 802 12 is_stmt 0
	bne	s8,zero,.L78
	.loc 2 803 13 is_stmt 1
	.loc 2 804 37 is_stmt 0
	lw	a3,4(s9)
	lw	a4,8(s9)
	li	s8,7
.LVL47:
...
.L79:
	...
	.loc 2 807 23 is_stmt 0
	sw	s2,4(s9)
	.loc 2 808 13 is_stmt 1
	.loc 2 808 24 is_stmt 0
	sw	s4,16(s9)
	j	.L89
.LVL48:
.L40:
...
.LBE39:
	...
	.loc 2 619 40 is_stmt 0
	addi	a4,a3,1
	sw	a4,4(s9)
	.loc 2 619 29
	sw	a3,16(s0)
	.loc 2 620 17 is_stmt 1
	.loc 2 620 29 is_stmt 0
	li	a4,6
.L106:
	.loc 2 701 25
	sb	a4,0(s0)
	.loc 2 702 13 is_stmt 1
	j	.L25
.L44:
	.loc 2 628 13
	.loc 2 629 52 is_stmt 0
	addi	a4,a4,1
	slli	a4,a4,2
	.loc 2 629 17
	sw	a4,48(s0)
	.loc 2 631 13 is_stmt 1
	.loc 2 631 26 is_stmt 0
	sw	a4,156(s0)
...
.LVL52:
	.loc 2 639 16
	beq	a0,zero,.L108
	.loc 2 642 13 is_stmt 1
.LVL53:
.LBB40:
.LBB26:
	.loc 2 474 5
	.loc 2 480 5
	.loc 2 480 18 is_stmt 0
	lw	a1,156(s0)
	.loc 2 481 9
	li	a2,0
	mv	a0,s1
...
.L50:
	...
	.loc 2 553 8 is_stmt 0
	beq	a1,a3,.L46
	.loc 2 556 5 is_stmt 1
	.loc 2 556 63 is_stmt 0
	addi	a4,a4,3
	sw	a4,152(s0)
	.loc 2 556 11
	add	a3,s0,a3
...
.LVL63:
	...
	sw	a2,64(s0)
	sw	a4,68(s0)
	.loc 2 250 5 is_stmt 1
	.loc 2 250 8 is_stmt 0
	bltu	a6,a3,.L46
	bne	a6,a3,.L85
	lw	a3,32(s0)
	bltu	a3,a1,.L46
...
.L86:
	...
	.loc 2 255 8 is_stmt 0
	lbu	a3,28(s0)
	li	a4,1
	bne	a3,a4,.L55
	.loc 2 256 9 is_stmt 1
	.loc 2 256 18 is_stmt 0
	lw	a1,16(s9)
	.loc 2 256 34
	lw	a4,12(s9)
	.loc 2 256 18
...
.L55:
	...
	.loc 2 264 8 is_stmt 0
	li	a4,1
	bne	s8,a4,.L39
	.loc 2 265 9 is_stmt 1
	.loc 2 265 28 is_stmt 0
	lw	a4,32(s0)
	.loc 2 265 12
	li	a2,-1
	.loc 2 265 28
...
.L58:
	...
	sw	a4,80(s0)
	sw	a3,84(s0)
	.loc 2 281 9 is_stmt 1
	.loc 2 281 12 is_stmt 0
	li	a2,1
	bne	a6,a2,.L60
	.loc 2 282 13 is_stmt 1
	.loc 2 282 36 is_stmt 0
	addi	a2,a4,4
	sltu	a4,a2,a4
	add	a4,a4,a3
	sw	a2,80(s0)
...
.L61:
	...
	.loc 2 679 25 is_stmt 0
	li	a4,5
	sb	a4,0(s0)
.L32:
	.loc 2 682 9 is_stmt 1
	.loc 2 685 13
	.loc 2 685 16 is_stmt 0
	lbu	a3,28(s0)
	li	a4,1
	bne	a3,a4,.L64
.L66:
...
.LBB45:
	...
	.loc 2 371 9
	.loc 2 371 14 is_stmt 0
	lw	a2,4(s9)
	.loc 2 371 12
	lw	a4,8(s9)
	beq	a2,a4,.L108
	.loc 2 374 9 is_stmt 1
	.loc 2 374 22 is_stmt 0
	lw	a3,4(s0)
	lw	a4,24(s0)
	.loc 2 374 59
	addi	a1,a2,1
...
.LBB28:
	...
	.loc 2 506 36 is_stmt 0
	sw	s6,32(s0)
	sw	s7,36(s0)
	j	.L48
.L49:
	.loc 2 517 9 is_stmt 1
	.loc 2 517 38 is_stmt 0
	sw	s6,40(s0)
	sw	s7,44(s0)
	j	.L50
.LVL70:
.L52:
	.loc 2 562 9 is_stmt 1
	.loc 2 562 36 is_stmt 0
	addi	a2,a4,1
	sw	a2,152(s0)
	.loc 2 562 24
	add	a4,s0,a4
...
.LBE46:
	...
	.loc 2 670 22 is_stmt 0
	lw	a3,4(s9)
	.loc 2 670 20
	lw	a4,8(s9)
	beq	a3,a4,.L108
	.loc 2 673 17 is_stmt 1
	.loc 2 673 22 is_stmt 0
	lw	a4,0(s9)
	.loc 2 673 36
	addi	a2,a3,1
	sw	a2,4(s9)
...
.LBE36:
.LBE47:
	.loc 2 706 13 is_stmt 1
	.loc 2 709 13
	.loc 2 709 25 is_stmt 0
	li	a4,7
	sb	a4,0(s0)
	j	.L74
.LVL75:
...
.LBB48:
.LBB37:
	.loc 2 327 13 is_stmt 1
	.loc 2 327 31 is_stmt 0
	lw	a3,8(s0)
	lw	a4,12(s0)
	.loc 2 334 16
	lw	a2,72(s0)
...
.L68:
	...
	sw	a3,128(s0)
	sw	a4,132(s0)
	.loc 2 342 13 is_stmt 1
	.loc 2 342 31 is_stmt 0
	sb	s3,104(s0)
	.loc 2 343 13 is_stmt 1
	j	.L71
.L70:
	.loc 2 346 13
	.loc 2 346 40 is_stmt 0
	lw	a4,136(s0)
	lw	a3,8(s0)
	lw	a2,140(s0)
	lw	a1,12(s0)
...
.LBE48:
	.loc 2 717 17
	.loc 2 717 20 is_stmt 0
	lw	a4,8(s9)
	bne	a4,a3,.L73
	.loc 2 718 21 is_stmt 1
	mv	a1,s9
	mv	a0,s0
	call	index_update
.LVL80:
...
.L74:
	...
	.loc 2 715 19
	bne	a4,zero,.L75
	.loc 2 727 13 is_stmt 1
	mv	a1,s9
	mv	a0,s0
	call	index_update
.LVL81:
	.loc 2 730 13
	.loc 2 730 19 is_stmt 0
	li	a2,24
	addi	a1,s0,128
	addi	a0,s0,80
	call	memcmp
...
.LBE52:
	...
	.loc 2 744 13
	.loc 2 745 13
	.loc 2 745 25 is_stmt 0
	sb	a4,0(s0)
.LVL84:
.L27:
	.loc 2 748 9 is_stmt 1
	.loc 2 751 13
	.loc 2 751 18 is_stmt 0
	mv	a1,s9
	mv	a0,s0
	call	fill_temp
.LVL85:
	.loc 2 751 16
	beq	a0,zero,.L108
	.loc 2 754 13 is_stmt 1
.LVL86:
.LBB53:
.LBB54:
	.loc 2 447 5
	.loc 2 447 11 is_stmt 0
	lui	a1,%hi(.LC1)
	li	a2,2
	addi	a1,a1,%lo(.LC1)
	addi	a0,s0,170
...
.L82:
	...
	.loc 2 816 28 is_stmt 0
	li	a5,1
	sb	a5,30(s0)
	j	.L89
.L81:
	.loc 2 818 9 is_stmt 1
	.loc 2 818 28 is_stmt 0
	sb	zero,30(s0)
	.loc 2 821 5 is_stmt 1
	.loc 2 821 12 is_stmt 0
	j	.L89
	.cfi_endproc
.LFE15:
...
.LVL104:
	...
	.loc 2 827 8 is_stmt 0
	beq	a0,zero,.L109
	.loc 2 830 5 is_stmt 1
	.loc 2 838 16 is_stmt 0
	lw	a1,12(sp)
	.loc 2 830 13
	sb	s1,29(a0)
	.loc 2 838 5 is_stmt 1
	.loc 2 838 16 is_stmt 0
	mv	a0,s1
...
.LVL105:
	...
	.loc 2 839 8 is_stmt 0
	bne	a0,zero,.L111
	.loc 2 840 9 is_stmt 1
.LDL1:
	.loc 2 850 5
	mv	a0,s0
	call	simple_free
...
.Letext0:
	...
	.file 7 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/toolchain/riscv/Linux/riscv64-unknown-elf/include/stdlib.h"
	.file 8 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/toolchain/riscv/Linux/lib/gcc/riscv64-unknown-elf/8.3.0/include/stdint-gcc.h"
	.file 9 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Common/xz/xz.h"
	.file 10 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Common/xz/xz_stream.h"
	.file 11 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Common/xz/xz_private.h"
	.file 12 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/toolchain/riscv/Linux/riscv64-unknown-elf/include/string.h"
...
.LASF215:
	.string	"/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Common/xz/xz_dec_stream.c"
.LASF52:
	.string	"_cookie"
.LASF85:
	.string	"__sglue"
