# 1 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_i2c.c"
# 1 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/build_out/bl602_std//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_i2c.c"
# 37 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_i2c.c"
...
# 38 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_i2c.c" 2
...
# 39 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_i2c.c" 2
# 71 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_i2c.c"
intCallback_Type * i2cIntCbfArra[I2C_ID_MAX][I2C_INT_ALL]= {{
# 71 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_i2c.c" 3 4
                                                            ((void *)0)
# 71 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_i2c.c"
                                                                }};
# 163 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_i2c.c"
void I2C_SendWord(I2C_ID_Type i2cNo, uint32_t data)
{
    uint32_t I2Cx = ((uint32_t)0x4000A300);


    ((void)0);
    ((*(volatile uint32_t*)(I2Cx+(0x88)))=(data));
}
# 180 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_i2c.c"
uint32_t I2C_RecieveWord(I2C_ID_Type i2cNo)
{
    uint32_t I2Cx = ((uint32_t)0x4000A300);
    ...
    ((void)0);
    return (*((volatile uint32_t*)(I2Cx+(0x8C))));
}
# 197 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_i2c.c"
void I2C_Enable(I2C_ID_Type i2cNo)
{
    uint32_t tmpVal;
    uint32_t I2Cx = ((uint32_t)0x4000A300);
    ...
    tmpVal = (*((volatile uint32_t*)(I2Cx+(0x80))));
    tmpVal = ( (tmpVal) |(1U<<(2U)));
    tmpVal = ( (tmpVal) |(1U<<(3U)));
    ((*(volatile uint32_t*)(I2Cx+(0x80)))=(tmpVal));

    tmpVal = (*((volatile uint32_t*)(I2Cx+(0x0))));
    tmpVal = ( (tmpVal) |(1U<<(0U)));
    ((*(volatile uint32_t*)(I2Cx+(0x0)))=(tmpVal));
}
# 223 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_i2c.c"
void I2C_Disable(I2C_ID_Type i2cNo)
{
    uint32_t tmpVal;
    uint32_t I2Cx = ((uint32_t)0x4000A300);
    ...
    tmpVal = (*((volatile uint32_t*)(I2Cx+(0x4))));
    tmpVal = ( (tmpVal) |(1U<<(16U)));
    tmpVal = ( (tmpVal) |(1U<<(19U)));
    tmpVal = ( (tmpVal) |(1U<<(20U)));
    ((*(volatile uint32_t*)(I2Cx+(0x4)))=(tmpVal));
}
# 257 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_i2c.c"
BL_Err_Type I2C_Reset(I2C_ID_Type i2cNo)
{
...
# 276 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_i2c.c"
void I2C_Init(I2C_ID_Type i2cNo, I2C_Direction_Type direct, I2C_Transfer_Cfg *cfg)
{
    uint32_t tmpVal;
    uint32_t I2Cx = ((uint32_t)0x4000A300);
    ...
    tmpVal = ( ((tmpVal)&(~(((1U<<(7U))-1)<<(8U)))) | ((uint32_t)(cfg->slaveAddr)<<(8U)) );
    if(cfg->subAddrSize > 0){
        tmpVal = ( (tmpVal) |(1U<<(4U)));
        tmpVal = ( ((tmpVal)&(~(((1U<<(2U))-1)<<(5U)))) | ((uint32_t)(cfg->subAddrSize-1)<<(5U)) );
    }else{
        tmpVal = ( (tmpVal) & (~(((1U<<(1U))-1)<<(4U))) );
    }
    tmpVal = ( ((tmpVal)&(~(((1U<<(8U))-1)<<(16U)))) | ((uint32_t)(cfg->dataSize-1)<<(16U)) );
    ((*(volatile uint32_t*)(I2Cx+(0x0)))=(tmpVal));


    ((*(volatile uint32_t*)(I2Cx+(0x8)))=(cfg->subAddr));




}
# 318 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_i2c.c"
void I2C_SetPrd(I2C_ID_Type i2cNo, uint8_t phase)
{
    uint32_t tmpVal;
    uint32_t I2Cx = ((uint32_t)0x4000A300);
    ...
    tmpVal = (*((volatile uint32_t*)(I2Cx+(0x10))));
    tmpVal = ( ((tmpVal)&(~(((1U<<(8U))-1)<<(0U)))) | ((uint32_t)(phase)<<(0U)) );
    tmpVal = ( ((tmpVal)&(~(((1U<<(8U))-1)<<(8U)))) | ((uint32_t)(phase)<<(8U)) );
    tmpVal = ( ((tmpVal)&(~(((1U<<(8U))-1)<<(16U)))) | ((uint32_t)(phase)<<(16U)) );
    tmpVal = ( ((tmpVal)&(~(((1U<<(8U))-1)<<(24U)))) | ((uint32_t)(phase)<<(24U)) );
    ((*(volatile uint32_t*)(I2Cx+(0x10)))=(tmpVal));
    tmpVal = (*((volatile uint32_t*)(I2Cx+(0x14))));
    tmpVal = ( ((tmpVal)&(~(((1U<<(8U))-1)<<(0U)))) | ((uint32_t)(phase)<<(0U)) );
    tmpVal = ( ((tmpVal)&(~(((1U<<(8U))-1)<<(8U)))) | ((uint32_t)(phase)<<(8U)) );
    tmpVal = ( ((tmpVal)&(~(((1U<<(8U))-1)<<(16U)))) | ((uint32_t)(phase)<<(16U)) );
    tmpVal = ( ((tmpVal)&(~(((1U<<(8U))-1)<<(24U)))) | ((uint32_t)(phase)<<(24U)) );
    ((*(volatile uint32_t*)(I2Cx+(0x14)))=(tmpVal));
    tmpVal = (*((volatile uint32_t*)(I2Cx+(0x18))));
    tmpVal = ( ((tmpVal)&(~(((1U<<(8U))-1)<<(0U)))) | ((uint32_t)(phase)<<(0U)) );
    tmpVal = ( ((tmpVal)&(~(((1U<<(8U))-1)<<(8U)))) | ((uint32_t)(phase)<<(8U)) );
    tmpVal = ( ((tmpVal)&(~(((1U<<(8U))-1)<<(16U)))) | ((uint32_t)(phase)<<(16U)) );
    tmpVal = ( ((tmpVal)&(~(((1U<<(8U))-1)<<(24U)))) | ((uint32_t)(phase)<<(24U)) );
    ((*(volatile uint32_t*)(I2Cx+(0x18)))=(tmpVal));
}
# 356 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_i2c.c"
void I2C_ClockSet(I2C_ID_Type i2cNo, uint32_t clk)
{
    uint8_t bclkDiv = 0;
    ...
    if(clk >= 100000){
        GLB_Set_I2C_CLK(1, 0);
        I2C_SetPrd(i2cNo, ((*((volatile uint32_t*)(0x4000F108)))/(bclkDiv+1)) / (clk*4)-1);
    }else if(clk >= 8000){
        GLB_Set_I2C_CLK(1, 9);
        I2C_SetPrd(i2cNo, (((*((volatile uint32_t*)(0x4000F108)))/(bclkDiv+1))/10) / (clk*4)-1);
    }else if(clk >= 800){
        GLB_Set_I2C_CLK(1, 99);
        I2C_SetPrd(i2cNo, (((*((volatile uint32_t*)(0x4000F108)))/(bclkDiv+1))/100) / (clk*4)-1);
    }else{
        GLB_Set_I2C_CLK(1, 255);
        I2C_SetPrd(i2cNo, (((*((volatile uint32_t*)(0x4000F108)))/(bclkDiv+1))/256) / (clk*4)-1);
    }
}
# 388 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_i2c.c"
void I2C_SetSclSync(I2C_ID_Type i2cNo, uint8_t enable)
{
    uint32_t tmpVal;
    uint32_t I2Cx = ((uint32_t)0x4000A300);
...
# 413 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_i2c.c"
BL_Sts_Type I2C_IsBusy(I2C_ID_Type i2cNo)
{
    uint32_t tmpVal;
    uint32_t I2Cx = ((uint32_t)0x4000A300);
    ...
    tmpVal = (*((volatile uint32_t*)(I2Cx+(0xC))));
    return ((( ((tmpVal)&(1U<<((0U)))) !=0 )) ? SET: RESET);
}
# 433 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_i2c.c"
BL_Sts_Type I2C_TransferEndStatus(I2C_ID_Type i2cNo)
{
    uint32_t tmpVal;
    uint32_t I2Cx = ((uint32_t)0x4000A300);
...
# 454 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_i2c.c"
BL_Err_Type I2C_MasterSendBlocking(I2C_ID_Type i2cNo, I2C_Transfer_Cfg *cfg)
{
    uint8_t i;
    uint32_t timeOut = 0;
    ...
    for(i=0; i<cfg->dataSize; i++){
        ...
        if((i + 1) % 4 == 0){
            timeOut = (160*1000*2);
            while(( (((*((volatile uint32_t*)(I2Cx+(0x84))))) & (((1U<<(2U))-1)<<(0U))) >> (0U) ) == 0){
                timeOut--;
                if(timeOut == 0){
                    I2C_Disable(i2cNo);
                    return TIMEOUT;
            ...
            ((*(volatile uint32_t*)(I2Cx+(0x88)))=(temp));
            temp = 0;
        }
    }
    if((cfg->dataSize%4) != 0){
...
# 518 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_i2c.c"
BL_Err_Type I2C_MasterReceiveBlocking(I2C_ID_Type i2cNo, I2C_Transfer_Cfg *cfg)
{
    uint8_t i = 0;
    uint32_t timeOut = 0;
    ...
    while(cfg->dataSize - i >= 4){
        timeOut = (160*1000*2);
        while(( (((*((volatile uint32_t*)(I2Cx+(0x84))))) & (((1U<<(2U))-1)<<(8U))) >> (8U) ) == 0){
            timeOut--;
            if(timeOut == 0){
                I2C_Disable(i2cNo);
                return TIMEOUT;
        ...
        temp = (*((volatile uint32_t*)(I2Cx+(0x8C))));
        { (cfg->data)[(i) ] = (uint8_t) ( (temp) ); (cfg->data)[(i) + 1] = (uint8_t) ( (temp) >> 8 ); (cfg->data)[(i) + 2] = (uint8_t) ( (temp) >> 16 ); (cfg->data)[(i) + 3] = (uint8_t) ( (temp) >> 24 ); };
        i += 4;
    }
    if(i < cfg->dataSize){
        timeOut = (160*1000*2);
...
# 586 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_i2c.c"
void I2C_IntMask(I2C_ID_Type i2cNo, I2C_INT_Type intType, BL_Mask_Type intMask)
{
    uint32_t tmpVal;
    uint32_t I2Cx = ((uint32_t)0x4000A300);
    ...
    switch(intType)
    {
        ...
        case I2C_FIFO_ERR_INT:
            if(intMask == UNMASK)
            {
                ...
                tmpVal = ( (tmpVal) |(1U<<(29U)));
                tmpVal = ( (tmpVal) & (~(((1U<<(1U))-1)<<(13U))) );
            }
            else
            {

                tmpVal = ( (tmpVal) & (~(((1U<<(1U))-1)<<(29U))) );
