...
.LFB1:
	.file 1 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/freertos_riscv_ram/event_groups.c"
	.loc 1 94 5
	.cfi_startproc
.LVL0:
	.loc 1 95 5
...
.LBB9:
	...
	.loc 1 105 29 is_stmt 0 discriminator 1
	li	a5,32
	sw	a5,12(sp)
	.loc 1 106 13 is_stmt 1 discriminator 1
	.loc 1 106 53 is_stmt 0 discriminator 1
	lw	a4,12(sp)
...
.L21:
	.cfi_restore_state
	.loc 1 321 60 is_stmt 1 discriminator 1
	call	vAssertCalled
.LVL29:
	.loc 1 322 5 discriminator 1
	.loc 1 325 9 discriminator 1
	.loc 1 325 20 is_stmt 0 discriminator 1
	call	xTaskGetSchedulerState
.LVL30:
	.loc 1 325 15 discriminator 1
	bne	a0,zero,.L22
	j	.L51
.LVL31:
.L23:
...
.LBE13:
.LBE15:
	.loc 1 353 14 is_stmt 1
	.loc 1 353 16 is_stmt 0
	beq	s3,zero,.L28
	.loc 1 366 13 is_stmt 1
	.loc 1 368 31 is_stmt 0
	snez	a1,s5
	slli	a1,a1,24
.LVL32:
...
.LVL35:
 ...
 #APP
# 403 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/freertos_riscv_ram/event_groups.c" 1
	ecall
# 0 "" 2
	.loc 1 403 39
 #NO_APP
...
.L50:
.LBE19:
	.loc 1 320 32 is_stmt 1 discriminator 1
	call	vAssertCalled
.LVL49:
	j	.L18
.LVL50:
...
.LBE20:
	...
	beq	s5,zero,.L35
	.loc 1 429 25 is_stmt 1
	.loc 1 429 53 is_stmt 0
	not	s1,s1
.LVL53:
	.loc 1 429 50
	and	s1,s1,a0
...
.L63:
	.cfi_restore_state
	.loc 1 469 58 is_stmt 1 discriminator 1
	call	vAssertCalled
.LVL69:
	j	.L57
.L62:
	.loc 1 468 32 discriminator 1
	call	vAssertCalled
.LVL70:
	j	.L56
	.cfi_endproc
...
.LVL99:
.L86:
	.loc 1 531 56 is_stmt 1 discriminator 1
	call	vAssertCalled
.LVL100:
	j	.L69
.LVL101:
...
.LVL121:
 ...
 #APP
# 255 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/freertos_riscv_ram/event_groups.c" 1
	ecall
# 0 "" 2
	.loc 1 255 39
 #NO_APP
...
.LVL125:
.L111:
	.loc 1 199 41 is_stmt 1 discriminator 1
	call	vAssertCalled
.LVL126:
...
.LVL146:
	...
	.loc 1 279 32 is_stmt 0
	and	a5,s1,a0
	.loc 1 279 19
	bne	a5,s1,.L104
	.loc 1 281 21 is_stmt 1
	.loc 1 281 49 is_stmt 0
	not	s1,s1
.LVL147:
	.loc 1 281 46
	and	s1,s1,a0
...
.L121:
	...
	.loc 1 626 50 is_stmt 0
	lw	a0,16(s0)
	.loc 1 626 15
	bne	a0,s1,.L120
	.loc 1 626 130 is_stmt 1 discriminator 1
	call	vAssertCalled
.LVL157:
	lw	a0,16(s0)
	...
	call	vTaskRemoveFromUnorderedEventList
.LVL158:
	.loc 1 622 43 is_stmt 0 discriminator 1
	lw	a5,4(s0)
	.loc 1 622 14 discriminator 1
	bne	a5,zero,.L121
.L122:
...
.Letext0:
	...
	.file 11 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/freertos_riscv_ram/config/event_groups.h"
	.file 12 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/freertos_riscv_ram/config/timers.h"
	.file 13 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/freertos_riscv_ram/config/task.h"
	.file 14 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/freertos_riscv_ram/config/FreeRTOSConfig.h"
...
.LASF125:
	.string	"UBaseType_t"
.LASF220:
	.string	"/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/freertos_riscv_ram/event_groups.c"
.LASF150:
	.string	"xListEnd"
.LASF21:
	.string	"_flock_t"
