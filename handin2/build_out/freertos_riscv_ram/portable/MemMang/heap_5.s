...
.LFB7:
	.file 1 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/freertos_riscv_ram/portable/MemMang/heap_5.c"
	.loc 1 345 1
	.cfi_startproc
.LVL0:
	.loc 1 346 1
...
.L11:
	...
	.loc 1 374 41 is_stmt 0
	lui	a2,%hi(.LANCHOR1)
	lw	a2,%lo(.LANCHOR1)(a2)
	.loc 1 374 11
	beq	a5,a2,.L4
	.loc 1 377 13 is_stmt 1
	.loc 1 377 41 is_stmt 0
	lw	a5,4(a5)
	add	a3,a5,a3
	sw	a3,4(a0)
	.loc 1 378 13 is_stmt 1
	.loc 1 378 75 is_stmt 0
	lw	a5,0(a4)
	lw	a5,0(a5)
	.loc 1 378 46
	sw	a5,0(a0)
...
.L20:
	...
	bgeu	s4,a3,.L21
	.loc 1 224 25 is_stmt 1
	.loc 1 224 56 is_stmt 0
	sw	s4,0(a5)
.L21:
	.loc 1 228 25 is_stmt 1
	.loc 1 233 21
	.loc 1 233 41 is_stmt 0
	or	s2,s2,a4
	sw	s2,4(s0)
	.loc 1 234 21 is_stmt 1
	.loc 1 234 46 is_stmt 0
	sw	zero,0(s0)
	.loc 1 248 13 is_stmt 1
	.loc 1 251 9
	.loc 1 253 5
...
.LVL40:
.L52:
	.loc 1 300 17 is_stmt 1 discriminator 1
	call	vAssertCalled
.LVL41:
	.loc 1 302 9 discriminator 1
	.loc 1 302 21 is_stmt 0 discriminator 1
	lw	a4,-4(s0)
	.loc 1 302 34 discriminator 1
	lw	a5,0(s1)
	and	a3,a4,a5
...
.L62:
	.cfi_restore_state
	.loc 1 299 73 is_stmt 1 discriminator 1
	call	vAssertCalled
.LVL44:
	.loc 1 300 9 discriminator 1
	.loc 1 300 11 is_stmt 0 discriminator 1
	lw	a5,-8(s0)
	bne	a5,zero,.L52
...
.LVL49:
	...
	.loc 1 415 7
	beq	a5,zero,.L66
	.loc 1 415 13 is_stmt 1 discriminator 1
	call	vAssertCalled
.LVL50:
	.loc 1 419 24 is_stmt 0 discriminator 1
	lw	s0,4(s3)
	.loc 1 419 10 discriminator 1
	beq	s0,zero,.L70
	lw	a5,0(s6)
.L69:
	.loc 1 441 36
...
.LVL62:
	...
	.loc 1 470 9
	.loc 1 471 9
	.loc 1 471 46 is_stmt 0
	sw	s2,4(s1)
	.loc 1 472 9 is_stmt 1
	.loc 1 472 51 is_stmt 0
	sw	a5,0(s1)
...
.L74:
	...
	bltu	a5,s2,.L73
	.loc 1 451 56 is_stmt 1 discriminator 1
	call	vAssertCalled
.LVL69:
	lw	a4,0(s6)
	j	.L73
...
.Letext0:
	...
	.file 10 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/freertos_riscv_ram/config/FreeRTOSConfig.h"
...
.LASF170:
	.string	"/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/freertos_riscv_ram/portable/MemMang/heap_5.c"
.LASF163:
	.string	"pvReturn"
.LASF88:
	.string	"__FILE"
