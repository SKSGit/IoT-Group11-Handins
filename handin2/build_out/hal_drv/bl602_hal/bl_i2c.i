# 1 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/hal_drv/bl602_hal/bl_i2c.c"
# 1 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/build_out/hal_drv//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/hal_drv/bl602_hal/bl_i2c.c"
# 30 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/hal_drv/bl602_hal/bl_i2c.c"
...
# 31 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/hal_drv/bl602_hal/bl_i2c.c" 2
...
# 32 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/hal_drv/bl602_hal/bl_i2c.c" 2
...
# 33 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/hal_drv/bl602_hal/bl_i2c.c" 2
...
# 34 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/hal_drv/bl602_hal/bl_i2c.c" 2
...
# 35 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/hal_drv/bl602_hal/bl_i2c.c" 2
# 45 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/hal_drv/bl602_hal/bl_i2c.c"
void i2c_set_freq(int freq, int i2cx)
{
    uint32_t tmp;
...
void i2c_clear_status(int i2cx)
{
    ...
    if (i2cx == 0) {
        ...
        ((*(volatile uint32_t*)(((uint32_t)0x4000A300)+(0x4)))=(tmpval));
    } else {
    }
...
void do_write_data(i2c_msg_t *pstmsg)
{
    ...
    ((*(volatile uint32_t*)(((uint32_t)0x4000A300)+(0x88)))=(temp));
...
void do_read_data(i2c_msg_t *pstmsg)
{
    ...
    count = pstmsg->len - pstmsg->idex;
    temp = (*((volatile uint32_t*)(((uint32_t)0x4000A300)+(0x8C))));
    if (count >= 4) {
        { (pstmsg->buf)[(pstmsg->idex) ] = (uint8_t) ( (temp) ); (pstmsg->buf)[(pstmsg->idex) + 1] = (uint8_t) ( (temp) >> 8 ); (pstmsg->buf)[(pstmsg->idex) + 2] = (uint8_t) ( (temp) >> 16 ); (pstmsg->buf)[(pstmsg->idex) + 3] = (uint8_t) ( (temp) >> 24 ); };
        count = 4;
    } else if (count < 4) {
        for (i = 0; i < count; i++) {
...
static void i2c_config_para(i2c_msg_t *pstmsg)
{
    ...
    if (pstmsg->i2cx == 0) {
        tmpval = (*((volatile uint32_t*)(((uint32_t)0x4000A300)+(0x0))));
        ...
        tmpval = ( ((tmpval)&(~(((1U<<(7U))-1)<<(8U)))) | ((uint32_t)(pstmsg->addr)<<(8U)) );
        if(pstmsg->subflag > 0){
            tmpval = ( (tmpval) |(1U<<(4U)));
            tmpval = ( ((tmpval)&(~(((1U<<(2U))-1)<<(5U)))) | ((uint32_t)(pstmsg->sublen-1)<<(5U)) );
        } else {
            tmpval = ( (tmpval) & (~(((1U<<(1U))-1)<<(4U))) );
        }

        tmpval = ( ((tmpval)&(~(((1U<<(8U))-1)<<(16U)))) | ((uint32_t)(pstmsg->len-1)<<(16U)) );
        ((*(volatile uint32_t*)(((uint32_t)0x4000A300)+(0x0)))=(tmpval));

        if(pstmsg->subflag > 0){
            ((*(volatile uint32_t*)(((uint32_t)0x4000A300)+(0x8)))=(pstmsg->subaddr));
        }
    } else {
    }
