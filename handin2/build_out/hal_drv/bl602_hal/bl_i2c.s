...
i2c_set_freq:
.LFB9:
	.file 1 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/hal_drv/bl602_hal/bl_i2c.c"
	.loc 1 46 1
	.cfi_startproc
.LVL0:
	.loc 1 47 5
...
.L9:
	...
	.loc 1 102 60 is_stmt 0
	li	a4,1073782784
.LVL17:
	sw	a2,904(a4)
	.loc 1 103 5 is_stmt 1
	.loc 1 103 33 is_stmt 0
	lw	a4,24(a0)
	add	a5,a4,a5
.LVL18:
	.loc 1 103 18
...
.L10:
	...
	.loc 1 99 15 is_stmt 0 discriminator 3
	lw	a3,16(a0)
	.loc 1 100 26 discriminator 3
	slli	a6,a4,3
	.loc 1 99 15 discriminator 3
	add	a3,a3,a1
	add	a3,a3,a4
...
.LVL25:
	...
	sb	a5,0(a4)
.LVL26:
	.loc 1 117 66 is_stmt 1
	.loc 1 117 100 is_stmt 0
	lw	a3,24(a0)
	lw	a4,16(a0)
	add	a4,a4,a3
	.loc 1 117 121
	...
	.loc 1 117 102
	sb	a3,1(a4)
	.loc 1 117 129 is_stmt 1
	.loc 1 117 163 is_stmt 0
	lw	a3,24(a0)
	lw	a4,16(a0)
	add	a4,a4,a3
	.loc 1 117 184
	...
	.loc 1 117 165
	sb	a3,2(a4)
	.loc 1 117 193 is_stmt 1
	.loc 1 117 227 is_stmt 0
	lw	a4,16(a0)
	lw	a3,24(a0)
	.loc 1 117 248
	srli	a5,a5,24
...
.LVL31:
.L14:
	.loc 1 121 13 is_stmt 1 discriminator 3
	.loc 1 121 43 is_stmt 0 discriminator 3
	lw	a3,16(a0)
	lw	a1,24(a0)
	add	a3,a3,a2
	add	a3,a3,a1
	...
	.loc 1 120 33 is_stmt 0 discriminator 3
	addi	a2,a2,1
.LVL32:
	.loc 1 122 18 discriminator 3
	srli	a5,a5,8
.LVL33:
.L12:
...
.Letext0:
	...
	.file 3 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/hal_drv/bl602_hal/bl_i2c.h"
	...
	.file 10 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_i2c.h"
	...
	.file 12 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/freertos_riscv_ram/portable/GCC/RISC-V/portmacro.h"
	.file 13 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_glb.h"
...
.LASF3:
	.string	"long int"
.LASF204:
	.string	"/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/hal_drv/bl602_hal/bl_i2c.c"
.LASF65:
	.string	"_flags"
.LASF57:
	.string	"_is_cxa"
