# 1 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.c"
# 1 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/build_out/hal_drv//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.c"
# 30 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.c"
...
# 31 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.c" 2
...
# 32 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.c" 2

# 1 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.h" 1
# 36 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.h"
...
# 34 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.c" 2
...
# 35 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.c" 2
...
static void gpio_init(uint8_t id, uint8_t tx_pin, uint8_t rx_pin, uint8_t cts_pin, uint8_t rts_pin)
{
    ...
    cfg.gpioPin = rx_pin;
    cfg.gpioMode = ((uint32_t)0x00000002U);
    cfg.pullType = ((uint32_t)0x00000000U);
    GLB_GPIO_Init(&cfg);
...
int bl_uart_data_send(uint8_t id, uint8_t data)
{
    ...
    ((*(volatile uint8_t*)(UARTx + (0x88)))=(data));
...
int bl_uart_data_recv(uint8_t id)
{
    ...
    if (UART_GetRxFifoCount(id) > 0) {
        ret = (*((volatile uint8_t*)(UARTx + (0x8C))));
    } else {
        ret = -1;
    }
...
int bl_uart_flush(uint8_t id)
{
    ...
    while ((32) != UART_GetTxFifoCount(id)) {
    }
...
{
    if (
# 219 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.c" 3 4
       ((void *)0) 
# 219 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.c"
            == parity) {
        return;
    }
...
int bl_uart_int_rx_notify_unregister(uint8_t id, cb_uart_notify_t cb, void *arg)
{
    ...
    g_uart_notify_arg[id].rx_cb = 
# 348 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.c" 3 4
                                 ((void *)0)
# 348 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.c"
                                     ;
    g_uart_notify_arg[id].rx_cb_arg = 
# 349 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.c" 3 4
                                     ((void *)0)
# 349 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.c"
                                         ;
...
int bl_uart_int_tx_notify_unregister(uint8_t id, cb_uart_notify_t cb, void *arg)
{
    ...
    g_uart_notify_arg[id].tx_cb = 
# 360 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.c" 3 4
                                 ((void *)0)
# 360 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.c"
                                     ;
    g_uart_notify_arg[id].tx_cb_arg = 
# 361 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.c" 3 4
                                     ((void *)0)
# 361 "/home/sadikubuntu/vcs/go/src/IoT-Group11-Handins/handin2/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.c"
                                         ;
...
static inline void uart_generic_notify_handler(uint8_t id)
{
    ...
    maskVal = (*((volatile uint32_t*)(UARTx+(0x24))));



    if(( ((tmpVal)&(1U<<((0U)))) !=0 ) && !( ((maskVal)&(1U<<((0U)))) !=0 )){
        ((*(volatile uint32_t*)(UARTx+(0x28)))=(0x1));
    }


    if(( ((tmpVal)&(1U<<((1U)))) !=0 ) && !( ((maskVal)&(1U<<((1U)))) !=0 )){
        ((*(volatile uint32_t*)(UARTx+(0x28)))=(0x2));
    ...
    if(( ((tmpVal)&(1U<<((2U)))) !=0 ) && !( ((maskVal)&(1U<<((2U)))) !=0 )){
    ...
    if(( ((tmpVal)&(1U<<((3U)))) !=0 ) && !( ((maskVal)&(1U<<((3U)))) !=0 )){
    ...
    if (( ((tmpVal)&(1U<<((4U)))) !=0 ) && !( ((maskVal)&(1U<<((4U)))) !=0 )){
        ((*(volatile uint32_t*)(UARTx+(0x28)))=(0x10));
    ...
    if(( ((tmpVal)&(1U<<((5U)))) !=0 ) && !( ((maskVal)&(1U<<((5U)))) !=0 )){
        ((*(volatile uint32_t*)(UARTx+(0x28)))=(0x20));
    }


    if(( ((tmpVal)&(1U<<((6U)))) !=0 ) && !( ((maskVal)&(1U<<((6U)))) !=0 )){
    }


    if(( ((tmpVal)&(1U<<((7U)))) !=0 ) && !( ((maskVal)&(1U<<((7U)))) !=0 )){
    }
